...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [0] = LAYOUT_5x6_5(
		KC_INS, 	KC_HOME, 	KC_END, 	KC_NO, 		TO(1), 		KC_NO,	 									KC_NO, 		KC_LEFT, 	KC_UP, 		KC_DOWN, 	KC_RGHT, 	KC_NO,
		...
		KC_SCLN, 	KC_Q, 		KC_J, 		KC_K, 		KC_X, 		KC_NO, 										KC_B, 		KC_M, 		KC_W, 		KC_V, 		KC_Z, 		KC_NO, 
								KC_LSFT, 	TO(1), 		KC_SPC, 	KC_LALT, 	KC_0, 				KC_LGUI, 	KC_RALT,	KC_ENT, 	TO(1), 		KC_RSFT, 		
		...
		KC_LSFT, 	KC_Z, 		KC_X, 		KC_C, 		KC_V, 		KC_NO, 										KC_N, 		KC_M, 		KC_COMM, 	KC_DOT, 	KC_SLSH, 	KC_NO, 
								KC_NO, 		KC_NO, 		KC_SPC, 	KC_NO, 		KC_LCTL, 			TO(0), 		KC_NO, 		KC_ENT, 	KC_NO, 		KC_NO, 		
																	KC_LALT, 	KC_DEL, 			KC_BSPC, 	KC_RCTL),
        
		[2] = LAYOUT_5x6_5(
		KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 		TO(1), 		KC_NO,										KC_NO, 		KC_LEFT, 	KC_UP, 		KC_DOWN, 	KC_RGHT, 	KC_NO, 
		KC_NO, 		KC_F1, 		KC_F2, 		KC_F3, 		KC_F4, 		KC_NO, 										KC_NO, 		KC_P7, 		KC_P8, 		KC_P9, 		KC_NUM, 	KC_NO, 
		KC_NO, 		KC_F5, 		KC_F6, 		KC_F7, 		KC_F8, 		KC_NO, 										KC_NO, 		KC_P4, 		KC_P5, 		KC_P6, 		KC_DOT, 	KC_NO, 
		KC_NO, 		KC_F9, 		KC_F10, 	KC_F11, 	KC_F12, 	KC_NO, 										KC_NO, 		KC_P1, 		KC_P2, 		KC_P3, 		KC_P0, 		KC_NO, 
								KC_NO, 		KC_NO, 		KC_SPC, 	KC_NO, 		KC_NO, 				TO(0), 		KC_NO, 		KC_ENT, 	KC_NO, 		KC_NO, 
																	KC_NO, 		KC_NO, 				KC_NO, 		KC_NO),
        
		
		[3] = LAYOUT_5x6_5(
		KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 		KC_NO, 										KC_NO, 		KC_LEFT, 	KC_UP, 		KC_DOWN, 	KC_RGHT, 	KC_NO, 	
		KC_NO, 		KC_COMM, 	KC_PERC, 	KC_AT, 		KC_QUOT, 	KC_NO, 										KC_NO, 		KC_0, 		KC_CIRC, 	KC_DLR, 	KC_NO, 		KC_NO, 
		KC_NO, 		KC_SLSH, 	KC_LCBR, 	KC_SCLN, 	KC_LPRN, 	KC_PLUS, 									KC_ASTR, 	KC_RPRN, 	KC_EQL, 	KC_RCBR, 	KC_MINS, 	KC_NO, 
		KC_NO, 		KC_HASH, 	KC_GRV, 	KC_AMPR, 	KC_QUES, 	KC_PIPE, 									KC_BSLS, 	KC_EXLM, 	KC_LBRC, 	KC_RBRC, 	KC_UNDS, 	KC_NO,
								KC_NO, 		KC_NO, 		KC_SPC, 	KC_NO, 		KC_NO, 				TO(0), 		KC_NO, 		KC_ENT, 	KC_NO, 		KC_NO, 
														KC_NO, 		KC_NO, 							KC_NO, 		KC_NO),
...
layer_state_t layer_state_set_user(layer_state_t state) {
	switch (get_highest_layer(state)) {
		...
		default: // for any other layers, or the default layer
			//gb_matrix_mode_noeeprom(RGB_MATRIX_STARTUP_MODE);
			break;
	}
    return state;
}